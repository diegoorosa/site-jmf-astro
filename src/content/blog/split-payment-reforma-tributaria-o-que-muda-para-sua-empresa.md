---
title: "Split Payment na Reforma: Impacto no Fluxo de Caixa"
...
image: "/assets/images/blog-split-payment-reforma.jpg"
...
## O Que Já Existe Parecido Hoje

O Split Payment não é um conceito inteiramente novo no sistema tributário brasileiro — ele se assemelha a mecanismos de retenção na fonte já praticados hoje, como a retenção de ISS, PIS/COFINS/CSLL e IRRF em pagamentos entre pessoas jurídicas (veja como funciona na [emissão de nota fiscal de serviços](/blog/nota-fiscal-de-servicos-como-emitir-corretamente)). A diferença é a escala: hoje a retenção se aplica a situações específicas; com o Split Payment, ela passa a ser a regra geral para praticamente toda transação tributada por IBS/CBS, em qualquer meio de pagamento.
...
**O Split Payment vai existir para todos os tipos de pagamento, inclusive dinheiro?**
Pagamentos em espécie são o caso mais difícil de capturar automaticamente, e tendem a ficar fora do mecanismo automático na prática — mas a tendência regulatória é reduzir cada vez mais a relevância de pagamentos em dinheiro nas operações empresariais, especialmente B2B.

**Empresas que vendem majoritariamente para consumidor final (B2C) sentem o mesmo impacto que as B2B?**
O mecanismo técnico do Split Payment se aplica a qualquer transação, mas o impacto no fluxo de caixa tende a ser mais sentido por empresas com ciclo financeiro mais longo (que vendem a prazo) do que por negócios que recebem majoritariamente à vista no B2C — esses últimos já operam com pouco ou nenhum "colchão" do imposto a recolher.

**Existe algum jeito de se opor ou ficar de fora do Split Payment?**
Não — é um mecanismo estrutural do novo sistema tributário, não uma opção. A única "decisão" disponível para empresas do Simples Nacional é sobre o regime híbrido (relacionado ao crédito de IBS/CBS), que é uma questão distinta do Split Payment em si.

**Como posso estimar hoje o tamanho do impacto no meu caixa?**
Calcule, para os últimos 12 meses, qual o valor médio de impostos (ICMS, ISS, PIS, COFINS) que sua empresa reteve entre o recebimento do cliente e o efetivo recolhimento ao fisco — esse é, aproximadamente, o volume de capital de giro que precisará ser substituído por outra fonte quando o Split Payment estiver em vigor para o seu tipo de transação.
...
- Lei Complementar 214/2025 — regulamentação do IBS/CBS e cronograma do Split Payment
- [Comitê Gestor do IBS](https://www.gov.br/cgibs/)
