...
imageAlt: "Empresário em reunião de planejamento de negócio"
---
...
O MEI é individual por definição. Se você vai se associar com alguém, precisará de outra estrutura.

**Credibilidade para contratos maiores**
Muitas empresas — especialmente médias e grandes — exigem fornecedores com CNPJ em LTDA ou SA. O MEI pode ser um impedimento para fechar contratos com certos clientes.

**Distribuição de lucros isenta de IR**
Na LTDA regularmente escriturada, a distribuição de lucros para os sócios é isenta de Imposto de Renda Pessoa Física. Essa é uma das maiores vantagens tributárias da estrutura — e não existe no MEI.

**Crescimento da equipe**
O MEI pode ter apenas um funcionário com salário mínimo ou piso da categoria. Para contratar mais pessoas, precisa de outra estrutura.
...
1. **Abertura de uma nova LTDA** — com contrato social, capital social, CNPJ novo, inscrição estadual e municipal, alvará
2. **Baixa do MEI** — encerramento formal do CNPJ do MEI no Portal do Empreendedor
...
**Dar baixa no MEI antes de a LTDA estar 100% operacional.** Se a LTDA ainda não tem CNPJ ativo, inscrições e conta bancária prontas, ficar sem nenhum CNPJ ativo no meio do processo pode gerar um período sem capacidade de emitir nota fiscal — interrompendo o faturamento.

**Manter contratos e cadastros em nome do MEI por inércia.** Contratos com fornecedores, certificados digitais, contas em marketplaces e cadastros bancários precisam ser atualizados para o CNPJ da LTDA — manter tudo no MEI antigo gera confusão fiscal e dificulta a separação contábil dos dois períodos.

**Não avaliar o regime tributário com antecedência.** Migrar para a LTDA sem simular o impacto no Anexo III vs. Anexo V (Fator R) pode significar pagar mais imposto do que o necessário desde o primeiro mês.

## O Que Fazer com o MEI Após Abrir a LTDA

Depois que a LTDA está ativa e operando:

1. Pare de emitir notas pelo MEI
2. Encerre contratos, cadastros e contas vinculados ao CNPJ do MEI
3. Dê baixa formal no Portal do Empreendedor (processo simples, online)
4. Guarde os comprovantes de pagamento do DAS-MEI por pelo menos 5 anos

A baixa do MEI é irreversível — se precisar reabrir, será um novo CNPJ.

## Perguntas frequentes

**Posso migrar para LTDA antes de ultrapassar o limite do MEI, só porque vejo que vou crescer?**
Sim, e em muitos casos é a decisão mais inteligente — não é preciso esperar ultrapassar o limite para migrar voluntariamente. Migrar com antecedência, de forma planejada, evita a pressa e os riscos da migração feita às pressas depois de já ultrapassar o teto.

**O CNPJ da LTDA é o mesmo número do CNPJ do MEI?**
Não. Como explicado acima, não existe migração direta — a LTDA é um CNPJ novo, completamente distinto do CNPJ do MEI, que é encerrado (baixado) separadamente.

**Os clientes que eu já tinha como MEI continuam sendo meus clientes na LTDA?**
Sim, a relação comercial continua — só muda o CNPJ que emite a nota fiscal a partir da data de início de operação da LTDA. Contratos em andamento podem precisar de um aditivo simples para refletir o novo CNPJ, dependendo da exigência do cliente.

**Vale a pena contratar advogado para o contrato social, ou o contador já resolve?**
Para a maioria das LTDAs simples (poucos sócios, capital social modesto, sem cláusulas complexas), o contador elabora o contrato social dentro do serviço de abertura. Advogado especializado vale a pena quando há cláusulas mais sofisticadas — acordo de sócios detalhado, vesting de cotas, cláusulas de saída — comuns em sociedades com investidores ou múltiplos sócios não familiares.

---

> **Pronto para dar o próximo passo?**
> A JMF cuida de todo o processo de abertura da sua LTDA em Blumenau, da documentação ao alvará.
...
- Lei Complementar 123/2006 — limite de faturamento do MEI e opção pelo Simples Nacional
- [Portal do Empreendedor — baixa do MEI](https://www.gov.br/empresas-e-negocios/pt-br/empreendedor)
