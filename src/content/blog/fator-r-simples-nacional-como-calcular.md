...
Ele foi criado pela [Lei Complementar 123/2006](https://www.planalto.gov.br/ccivil_03/leis/lcp/lcp123.htm) e regulamentado pela [Resolução CGSN 140/2018](https://www.in.gov.br/en/web/dou/-/resolucao-cgsn-n-140-de-11-de-marco-de-2018-184175098) para determinar em qual dos dois anexos de serviços a empresa se enquadra:
...
A [Calculadora do Fator R](/calculadora-fator-r) da JMF resolve esse cálculo automaticamente para os seus números reais.
...
1. **Calculadora online:** use a [Calculadora do Fator R](/calculadora-fator-r) gratuita da JMF — informe a folha e o faturamento dos últimos 12 meses e veja imediatamente em qual anexo você está.
...
> **→ [Calcule agora: Calculadora do Fator R](/calculadora-fator-r)**

## Perguntas frequentes

**Minha empresa tem atividades no Anexo III e no Anexo V ao mesmo tempo. Como funciona?**
Quando a empresa exerce mais de uma atividade e pelo menos uma delas está sujeita ao Fator R (Anexo V), o cálculo do Fator R é feito sobre a receita bruta total da empresa (todas as atividades somadas), não só a parcela do Anexo V. Se o resultado for ≥ 28%, a totalidade da receita tributada por atividades de serviço migra para o Anexo III.

**O pró-labore precisa ser pago todo mês para contar no Fator R?**
Sim — o que entra no cálculo é o pró-labore efetivamente pago e registrado na folha nos últimos 12 meses, não um valor apenas previsto em contrato social. Pró-labore "no papel" mas não pago de fato não conta.

**Sócio que não trabalha na empresa pode ter pró-labore para fins de Fator R?**
Tecnicamente o pró-labore deveria remunerar o trabalho efetivo do sócio na empresa. Usar pró-labore apenas como estratégia artificial de enquadramento, sem labor real correspondente, é uma prática que pode ser questionada pela Receita Federal em fiscalização — o planejamento via Fator R deve refletir uma estrutura de remuneração real, não fictícia.

**Existe alguma desvantagem em manter o Fator R sempre acima de 28%?**
A principal "desvantagem" é o custo de INSS sobre o pró-labore mais alto necessário para atingir o percentual — por isso o cálculo de custo-benefício (mostrado no exemplo acima) é sempre necessário antes de aumentar o pró-labore artificialmente só para alcançar a faixa.
